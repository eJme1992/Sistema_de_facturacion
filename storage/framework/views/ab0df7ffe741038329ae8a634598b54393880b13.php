    ...
    <form method="POST" files="true" action="/admin/<?php echo e($type); ?>s/<?php echo e($product->id); ?>" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-2">
                ...
                <select class="form-control" name="id_categoria" value="<?php echo e(old('id_categoria', $product->id_categoria)); ?>">
            ...
            <div class="form-row">
                <div class="form-group col-md-2">
                    ...
                    <input type="number" min="1" class="form-control" name="codigo" value="<?php echo e(old('codigo', $product->codigo)); ?>" >
                </div>
            </div>
            ...
            <input type="hidden" class="form-control" name="quedan" value="<?php echo e(old('quedan', $product->quedan)); ?>" >

            <div class="form-row">
                <div class="form-group col-md-1">
                    <label>Costo</label>
                    <input class="form-control" name="costo" value="<?php echo e(old('costo', $product->costo)); ?>" >
                </div>
            </div>
            
            <div class="form-group col-md-1">
                <label>Monto</label>
                <input class="form-control" name="monto" value="<?php echo e(old('monto', $product->monto)); ?>" >
            </div>
