    ...
    <form action="<?php echo e(route('users.update', [$type, $user])); ?>" method="POST">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" name="telefono" value="<?php echo e(old('telefono', $user->telefono)); ?>" >
            </div>
            ...
            <div class="form-group col-md-3">
                ...
                <input require type="password" class="form-control" name="password" value="<?php echo e(old('password', $user->password)); ?>" >
            </div>
            <?php else: ?>
