...
<?php $__env->startSection('content2'); ?>
    ...
    <form method="POST" action="/admin/<?php echo e($type); ?>s/<?php echo e($category->id); ?>">
        ...
        <div class="form-row">
            <div class="form-group col-md-3">
                <label>Nombre</label>
                <input type="text" class="form-control text-uppercase" name="nombre" value="<?php echo e(old('nombre', $category->nombre)); ?>" >
            </div>
